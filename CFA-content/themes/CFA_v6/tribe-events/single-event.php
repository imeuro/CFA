...
<div id="tec-content" class="tec-single">
	...
	<?php the_title( '<h1 class="tec-event-title">', '</h1>' ); ?>

	<?php echo tribe_events_event_schedule_details( $event_id, '<h2 class="tec-event-schedule">', '</h2>' ); ?>


	<?php while ( have_posts() ) :  the_post(); ?>
		<div id="event-<?php the_ID(); ?>" class="tec-event-details">
