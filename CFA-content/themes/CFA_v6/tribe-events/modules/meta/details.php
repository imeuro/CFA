...
<h2 class="tribe-events-single-section-title"> <?php esc_html_e( 'Details', 'the-events-calendar' ); ?> </h2>
	...
	if ( tribe_event_is_all_day() && tribe_event_is_multiday() ) :
		?>
		<p>
			<strong class="tribe-events-start-date-label"> <?php esc_html_e( 'Start:', 'the-events-calendar' ); ?> </strong>
			<span><abbr class="tribe-events-abbr tribe-events-start-date published dtstart" title="<?php echo esc_attr( $start_ts ); ?>"> <?php echo esc_html( $start_date ); ?> </abbr></span>
		</p>
		<p>
			<strong class="tribe-events-end-date-label"> <?php esc_html_e( 'End:', 'the-events-calendar' ); ?> </strong>
			<span><abbr class="tribe-events-abbr tribe-events-end-date dtend" title="<?php echo esc_attr( $end_ts ); ?>"> <?php echo esc_html( $end_date ); ?> </abbr></span>
		</p>
	<?php
	...
	elseif ( tribe_event_is_all_day() ):
		?>
		<p>
			<strong class="tribe-events-start-date-label"> <?php esc_html_e( 'Date:', 'the-events-calendar' ); ?> </strong>
			<span><abbr class="tribe-events-abbr tribe-events-start-date published dtstart" title="<?php echo esc_attr( $start_ts ); ?>"> <?php echo esc_html( $start_date ); ?> </abbr></span>
		</p>
	<?php
	// Multiday events
	elseif ( tribe_event_is_multiday() ) :
		?>
		<p>
			<strong class="tribe-events-start-datetime-label"> <?php esc_html_e( 'Start:', 'the-events-calendar' ); ?> </strong>
			<span>
		...
		<p>
			<strong class="tribe-events-end-datetime-label"> <?php esc_html_e( 'End:', 'the-events-calendar' ); ?> </strong>
			<span>
	...
	// Single day events
		...
		<p>
			<strong class="tribe-events-start-time-label"> <?php echo esc_html( $time_title ); ?> </strong>
			<span>
	...
	if ( ! empty( $cost ) ) : ?>
		<p>
			<strong class="tribe-events-event-cost-label"> <?php esc_html_e( 'Cost:', 'the-events-calendar' ); ?> </strong>
	...
	if ( ! empty( $website ) ) : ?>
		...
		<?php if ( ! empty( $website_title ) ): ?>
			<strong class="tribe-events-event-url-label"> <?php echo esc_html( $website_title ); ?> </strong>
		<?php endif; ?>
